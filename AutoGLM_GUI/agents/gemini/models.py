...
BENCHMARKS: list[ModelBenchmark] = [
    ...
    ModelBenchmark("gpt-5-nano",    "openai",  7443, "NO_TOOL",    False, "不支持 tool_choice"),
    # --- 智谱 GLM ---
    ...
    ModelBenchmark("glm-4v-plus",            "zhipu",  2303, "NO_TOOL",    False, "不支持 function calling"),
    ModelBenchmark("GLM-4.1V-Thinking-Flash","zhipu",  4105, "NO_TOOL",    False, "不支持 function calling"),
    # --- Google Gemini ---
    ModelBenchmark("gemini-3.1-pro-preview", "google",  6288, "tap",        True,  "坐标精准"),
    ModelBenchmark("gemini-2.5-flash",       "google",  4988, "tap",        True,  "性价比"),
    ModelBenchmark("gemini-3-flash-preview", "google", 47907, "launch_app", True,  "异常慢(代理问题)"),
    # --- Anthropic ---
    ModelBenchmark("claude-sonnet-4-20250514","anthropic",109272,"launch_app",True, "代理转发极慢"),
]
