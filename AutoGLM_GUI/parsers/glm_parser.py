"""GLM Agent parser with enhanced AST parsing."""
...
class GLMParser:
    """Parse GLM Agent function-call style outputs.

    Handles formats like:
        do(action="Tap", coordinate=[500, 500])
        finish(message="Task completed")

    Uses custom parameter extraction for robust parsing of complex nested structures.
