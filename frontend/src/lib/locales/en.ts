export const en = {
  ...
  deviceSidebar: {
    ...
    androidAgentTab: 'Android Agent',
    androidAgentTitle: 'Add Android Agent',
    androidAgentDescription:
      'Generate a pairing code, then complete the bind inside the Android Agent app. Claimed agents will appear in the registry list below.',
    androidAgentGeneratePairing: 'Generate Pairing Code',
    androidAgentRegeneratePairing: 'Regenerate Pairing Code',
    androidAgentPairingCode: 'Pairing Code',
    androidAgentPairingExpiresAt: 'Expires At',
    androidAgentHeartbeatInterval: 'Suggested Heartbeat Interval',
    androidAgentRegistryTitle: 'Registered Android Agents',
    androidAgentRegistryEmpty: 'No Android Agents have been registered yet',
    androidAgentRefreshRegistry: 'Refresh Registry',
    androidAgentLoadingRegistry: 'Loading registry...',
    androidAgentLoadError: 'Failed to load Android Agent registry',
    androidAgentGenerateError: 'Failed to generate Android Agent pairing code',
    androidAgentStatusPaired: 'Paired',
    androidAgentStatusConnected: 'Connected',
    androidAgentStatusStale: 'Stale',
    androidAgentLastSeen: 'Last Seen',
    androidAgentCapabilities: 'Capabilities',
  ...
  toasts: {
    ...
    reverseAgentLoadError: 'Failed to load Android Agent registry',
    reverseAgentPairingError: 'Failed to generate Android Agent pairing code',
  },
  history: {
    title: 'Task History',
