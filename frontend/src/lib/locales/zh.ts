export const zh = {
  ...
  deviceSidebar: {
    ...
    androidAgentTitle: '添加 Android Agent',
    androidAgentDescription:
      '生成配对码后，在 Android Agent App 里完成绑定。绑定后的 Agent 会出现在下面的注册表列表里。',
    androidAgentGeneratePairing: '生成配对码',
    androidAgentRegeneratePairing: '重新生成配对码',
    androidAgentPairingCode: '配对码',
    androidAgentPairingExpiresAt: '有效期至',
    androidAgentHeartbeatInterval: '心跳建议间隔',
    androidAgentRegistryTitle: '已注册 Android Agent',
    androidAgentRegistryEmpty: '还没有已注册的 Android Agent',
    androidAgentRefreshRegistry: '刷新注册表',
    androidAgentLoadingRegistry: '正在加载注册表...',
    androidAgentLoadError: '加载 Android Agent 注册表失败',
    androidAgentGenerateError: '生成 Android Agent 配对码失败',
    androidAgentStatusPaired: '已配对',
    androidAgentStatusConnected: '已连接',
    androidAgentStatusStale: '连接过期',
    androidAgentLastSeen: '最近心跳',
    androidAgentCapabilities: '能力',
    remoteTab: '远程设备',
    remoteUrl: '远程服务器 URL',
  ...
  toasts: {
    ...
    reverseAgentLoadError: '加载 Android Agent 注册表失败',
    reverseAgentPairingError: '生成 Android Agent 配对码失败',
  },
  history: {
    title: '任务历史',
