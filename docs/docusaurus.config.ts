...
const config: Config = {
  ...
  organizationName: 'AutoGLM', // Optional
  projectName: 'AutoGLM-GUI', // Optional
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} AutoGLM-GUI`,
    },
    prism: {
