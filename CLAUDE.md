...
10. **Package Manager Consistency**: Use the same package manager (pnpm) in both package.json and build scripts (build_electron.py). Mixing npm and pnpm can cause dependency tree inconsistencies.
